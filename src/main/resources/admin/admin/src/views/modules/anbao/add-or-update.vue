               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="安保姓名" prop="anbaoName">
                       <el-input v-model="ruleForm.anbaoName"
                                 placeholder="安保姓名" clearable  :readonly="ro.anbaoName"></el-input>
                   </el-form-item>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="安保手机号" prop="anbaoPhone">
                       <el-input v-model="ruleForm.anbaoPhone"
                                 placeholder="安保手机号" clearable  :readonly="ro.anbaoPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="安保身份证号" prop="anbaoIdNumber">
                       <el-input v-model="ruleForm.anbaoIdNumber"
                                 placeholder="安保身份证号" clearable  :readonly="ro.anbaoIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.anbaoPhoto" label="安保照片" prop="anbaoPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.anbaoPhoto?$base.url+ruleForm.anbaoPhoto:''"
                            @change="anbaoPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   anbaoName: [
                              { required: true, message: '安保姓名不能为空', trigger: 'blur' },
                          ],
                   anbaoPhone: [
                              {  required: true, message: '安保手机号不能为空', trigger: 'blur' },
                   ...
                   anbaoIdNumber: [
                              { required: true, message: '安保身份证号不能为空', trigger: 'blur' },
                   ...
                   anbaoPhoto: [
                              { required: true, message: '安保照片不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`anbao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.anbaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            anbaoPhotoUploadChange(fileUrls){
                this.ruleForm.anbaoPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
