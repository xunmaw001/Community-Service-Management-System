...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;"
    ...
    <view class="right-content" @tap="onPageTap('fangwu')"
...
<view class="list-box style1"
    ...
    <view @tap="onDetailTap('fangwu',product.id)" v-for="(product,index) in fangwuList" :key="index"
          class="list-item"
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let fangwu = await this.$api.list('fangwu', {
                page: 1,
                limit: 6,
                });
