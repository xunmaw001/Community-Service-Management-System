	...
	<script>
		export default {
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.info('anbaoFenpei', this.anbaoFenpeiId);
                    this.detail = res.data
					// 主图
					this.swiperList = this.detail.anbaoFenpeiPhoto ? this.detail.anbaoFenpeiPhoto.split(",") : [];
				},
